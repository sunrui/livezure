...
class WndBasicDeviceDelete : public CWindowWnd, public INotifyUI, public IMessageFilterUI
{
public:
	WndBasicDeviceDelete(WndBasicDevice * pWndBasicDevice, db_account_device_t * device)
	{
		m_pWndBasicDevice = pWndBasicDevice;
		m_device = device;
	}

	LPCTSTR GetWindowClassName() const { return _T("WndBasicDeviceDelete UI"); };
	...
	LRESULT OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
		...
		CControlUI* pRoot = builder.Create(_T("WndBasicDeviceDelete.xml"), (UINT)0, NULL, &m_pm);
