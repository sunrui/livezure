...
static int
vector_insert(vector_t vector, void *data, unsigned int len, int pos)
{
 ...
 */
int
vector_append(vector_t vector, void *data, unsigned int len)
{
	return vector_insert(vector, data, len, INSERT_APPEND);
}

int
vector_prepend(vector_t vector, void *data, unsigned int len)
{
 ...
 */
void *
vector_getentry(vector_t vector, unsigned int pos, unsigned int * size)
{
