 ...
 */
extern int vector_append(vector_t vector, void *data, unsigned int len);
extern int vector_prepend(vector_t vector, void *data, unsigned int len);
...
*/
extern void *vector_getentry(vector_t vector, unsigned int pos,
unsigned int * size);
...
*/
extern unsigned int vector_length(vector_t vector);
