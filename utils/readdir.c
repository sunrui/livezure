/*
 * this file is ported and modified from php open source
 *
 * @author rui.sun 2013_1_3 12:14
 */
#include <malloc.h>
#include <string.h>
#include <errno.h>
...
//	filespec = (char *)malloc(strlen(dir) + 2 + 1); rui.sun changed for copy '\0'
	filespec = (char *)malloc(strlen(dir) + 3 + 1);
	strcpy(filespec, dir);
...
struct dirent *readdir(DIR *dp)
{
	...
	strncpy(dp->dent.d_name, dp->fileinfo.cFileName, _MAX_FNAME+1);
	dp->dent.d_ino = 1;
