/*
 * porting from tiny proxy project
 * web: http://www.koders.com/c/fid92BCD7327CEFD1F136B45FE230CAC7B4797BACE3.aspx
 ...
 *          negative upon error
 */
extern unsigned int hashmap_return_entry(hashmap_t map, hashmap_iter iter,
	char * *key, void * *data);
 ...
 */
extern unsigned int hashmap_entry_by_key(hashmap_t map, const char *key,
	void * *data);
 ...
 */
extern unsigned int hashmap_search(hashmap_t map, const char *key);
 ...
 */
extern unsigned int hashmap_remove(hashmap_t map, const char *key);
